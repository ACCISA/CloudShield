...
class TestUserCreate:
    ...
    def test_password_none_is_allowed_for_auto_generation(self):
        """Test that password=None is accepted (auto-generated by service layer)."""
        user = UserCreate(email="nopwd@example.com", full_name="No Pwd", password=None)
