...
const ImageEditButton = ({ onClick, themeColors }) => (
  <button
    onClick={onClick}
    style={{
      position: "absolute",
      ...
      >
        ...
        >
          ...
          <div style={{ position: "relative" }}>
            ...
            <ImageEditButton onClick={() => fileRef.current?.click()} themeColors={themeColors} />
            <input
              ref={fileRef}
              type="file"
              accept="image/*"
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <div style={{ position: "relative" }}>
            ...
            <ImageEditButton onClick={() => logoRef.current?.click()} themeColors={themeColors} />
            <input
              ref={logoRef}
              type="file"
              accept="image/*"
