...
describe("GroupsModal Component", () => {
  ...
  describe("Rendering", () => {
    ...
    test("shows Edit Group title in edit mode", () => {
      ...
      render(<GroupsModal open={true} onClose={mockOnClose} groupData={groupData} />);
  ...
  describe("Basic Info Step", () => {
    ...
    test("renders description textarea", () => {
      render(<GroupsModal open={true} onClose={mockOnClose} />);
      expect(screen.getByPlaceholderText("Enter a brief description of the group")).toBeInTheDocument();
    });
    ...
    test("allows typing in description field", async () => {
      render(<GroupsModal open={true} onClose={mockOnClose} />);
      const descInput = screen.getByPlaceholderText("Enter a brief description of the group");
  ...
  describe("Workstations Selection Step", () => {
    test("renders workstation search input", async () => {
      ...
      expect(screen.getByPlaceholderText("Search workstations...")).toBeInTheDocument();
    });
  });
  ...
  describe("Form Submission", () => {
    test("calls onSubmit with form data when Create is clicked", async () => {
      render(<GroupsModal open={true} onClose={mockOnClose} onSubmit={mockOnSubmit} />);
  ...
  describe("Edge Cases", () => {
    test("handles reopening modal", async () => {
      const { rerender } = render(<GroupsModal open={true} onClose={mockOnClose} />);
    ...
    test("handles switching from create to edit mode", () => {
      ...
      rerender(<GroupsModal open={true} onClose={mockOnClose} groupData={groupData} />);
    ...
    test("handles image upload change event", async () => {
      ...
      const fileInput = screen.getByPlaceholderText("Enter group name").parentElement.parentElement.parentElement.querySelector('input[type="file"]');
