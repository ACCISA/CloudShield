...
describe("TwoFactorOptionItem", () => {
  ...
  it("renders with title", () => {
    render(
      <TwoFactorOptionItem type="sms" title="SMS" onClick={mockOnClick} />
    );
  ...
  it("renders without subtitle when not provided", () => {
    render(
      <TwoFactorOptionItem type="email" title="Email" onClick={mockOnClick} />
    );
  ...
  it("uses sms as default type", () => {
    const { container } = render(
      <TwoFactorOptionItem title="Default" onClick={mockOnClick} />
    );
  ...
  it("does not throw error when onClick is undefined and key is pressed", () => {
    render(<TwoFactorOptionItem type="sms" title="SMS" />);
    const container = screen.getByText("SMS").closest("div").parentElement;
    expect(() => {
      fireEvent.keyDown(container, { key: "Enter" });
    }).not.toThrow();
