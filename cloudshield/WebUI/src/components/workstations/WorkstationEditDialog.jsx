    ...
    <Dialog open={open} onClose={onClose} PaperProps={darkDialogPaper}>
      <DialogTitle sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', pr: 1 }}>
        <Box display="flex" alignItems="center" gap={1}>
          ...
          <Typography fontWeight={600}>Edit Workstation</Typography>
        </Box>
      ...
      <DialogContent dividers sx={{ borderColor: 'rgba(255,255,255,0.12)' }}>
        ...
        {/* CLICKABLE PLANS (BASIC shows CURRENT when selected) */}
      ...
      <DialogActions sx={{ p: 2, gap: 1.5, justifyContent: 'space-between' }}>
        <Button
          onClick={onDelete}
