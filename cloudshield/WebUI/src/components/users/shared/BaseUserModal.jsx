...
import { modalStyles as styles } from "./userModalStyles";
 ...
 * @param {Object} props.form - User form hook object
 * @param {string} props.title - Modal title
 * @param {Function} props.renderFooterActions - Function to render footer action buttons
 * @param {Function} props.renderExtraHeaderActions - Optional function to render extra header actions
 */
